...
class GoogleAuthController extends Controller
{
    public function redirect()
    {
        $parameters = [
            ...
            'redirect_uri' => 'https://utspbffathi1071.sistemapotekmitragaluh.com/api/oauth/register/call-back',
            'response_type' => 'code',
            'scope' => 'email profile',
            'access_type' => 'offline',
    ...
    public function callbackGoogle(Request $request)
    {
        ...
        if (!$code) {
            return response()->json(['error' => 'Authorization code not found'], 404);
        }
        ...
        try {
            ...
            return response()->json(['error' => 'Something went wrong', 'details' => $th->getMessage()], 404);
        }
    }
}